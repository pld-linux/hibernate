...
Wymaga ³at Software Suspend 2 dostêpnych pod http://www.suspend2.net/
Po zainstalowaniu 'hibernate -h' poka¿e dostêpne opcje, które mo¿na 
ustawiæ w /etc/hibernate/hibernate.conf .
